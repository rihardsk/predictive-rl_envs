...
import org.rlcommunity.btanner.agentLib.functionApproximators.CMAC.CombinatorialTCFactory;
 ...
 * @author Brian Tanner
 */
public class EpsilonGreedyCombiTCExperienceReplaySarsaLambda extends AbstractSarsa {

    public static ParameterHolder getDefaultParameters() {
        FunctionApproximatorFactoryInterface FAF = new CombinatorialTCFactory();
    ...
    protected FunctionApproximatorFactoryInterface makeFunctionApproximatorFactory() {
        return new CombinatorialTCFactory();
    }
    ...
    public EpsilonGreedyCombiTCExperienceReplaySarsaLambda(ParameterHolder p) {
        super(p);
    }

    public EpsilonGreedyCombiTCExperienceReplaySarsaLambda() {
