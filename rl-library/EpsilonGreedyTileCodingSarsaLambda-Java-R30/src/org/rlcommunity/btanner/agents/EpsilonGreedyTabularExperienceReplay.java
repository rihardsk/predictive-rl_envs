 ...
 * @author Brian Tanner
 */
public class EpsilonGreedyTabularExperienceReplay extends AbstractSarsa {
    ...
    public EpsilonGreedyTabularExperienceReplay(ParameterHolder p) {
        super(p);
    }

    public EpsilonGreedyTabularExperienceReplay() {
