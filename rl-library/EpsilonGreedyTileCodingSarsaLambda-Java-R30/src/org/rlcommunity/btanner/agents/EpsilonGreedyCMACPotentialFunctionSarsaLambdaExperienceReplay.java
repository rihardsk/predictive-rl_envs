 ...
 * @author Brian Tanner
 */
public class EpsilonGreedyCMACPotentialFunctionSarsaLambdaExperienceReplay extends AbstractSarsa  implements Unloadable{
    ...
    public EpsilonGreedyCMACPotentialFunctionSarsaLambdaExperienceReplay(ParameterHolder p) {
        super(p);
    }

    public EpsilonGreedyCMACPotentialFunctionSarsaLambdaExperienceReplay() {
        this(getDefaultParameters());
    }

    @Override
    protected Vector<AbstractLearningBoosterFactory> makeBoosterFactories() {
        Vector<AbstractLearningBoosterFactory> localBoosters = new Vector<AbstractLearningBoosterFactory>();
        localBoosters.add(new ExperienceReplayLearningBoosterFactory());
        return localBoosters;
    }
}
