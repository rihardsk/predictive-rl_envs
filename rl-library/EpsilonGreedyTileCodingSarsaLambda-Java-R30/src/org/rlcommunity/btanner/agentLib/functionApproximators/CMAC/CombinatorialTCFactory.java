 ...
 * @author Brian Tanner
 */
public class CombinatorialTCFactory implements FunctionApproximatorFactoryInterface {

    public FunctionApproximatorInterface makeFunctionApproximator(TaskSpec theTaskObject, ParameterHolder p) {
       return new CombinatorialTileCoder(theTaskObject,p);
    }

    public void addToParameterHolder(ParameterHolder p) {
       CombinatorialTileCoder.addToParameterHolder(p);
    }
