 ...
 * @author Brian Tanner
 */
public class TabularFunctionApproximatorFactory implements FunctionApproximatorFactoryInterface {

    public FunctionApproximatorInterface makeFunctionApproximator(TaskSpec o, ParameterHolder p) {
        return new TabularQFunction(o,p);
    }

    public void addToParameterHolder(ParameterHolder p) {
        TabularQFunction.addToParameterHolder(p);
    }
