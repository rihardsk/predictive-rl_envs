 ...
 * @author Brian Tanner
 */
public class SoftMaxActionSelectorFactory implements ActionSelectorFactoryInterface{

    public ActionSelectorInterface makeActionSelector(TaskSpec o, ParameterHolder p) {
        return new SoftMaxActionSelector(o, p);
    }

    public void addToParameterHolder(ParameterHolder p) {
      SoftMaxActionSelector.addToParameterHolder(p);
    }
