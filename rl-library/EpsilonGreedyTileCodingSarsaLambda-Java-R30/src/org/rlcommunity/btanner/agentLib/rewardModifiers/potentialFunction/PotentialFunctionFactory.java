 ...
 * @author Brian Tanner
 */
public class PotentialFunctionFactory extends AbstractRewardModifierFactory {
    public PotentialFunctionFactory(){
        super();
    }

    @Override
    public RewardModifierInterface makeRewardModifier(TaskSpec theTaskObject, ParameterHolder p) {
        return new PotentialFunctionRewardModifier(theTaskObject, p);
    }
