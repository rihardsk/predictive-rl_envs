 ...
 * @author Brian Tanner
 */
public class ExpectedExperienceReplayLearningBoosterFactory extends AbstractLearningBoosterFactory {

    public ExpectedExperienceReplayLearningBoosterFactory(){
        
    }
    public ExpectedExperienceReplayLearningBoosterFactory(LearningModuleInterface theLearningModule, ActionSelectorInterface theActionSelector) {
    ...
    public LearningBoosterInterface makeLearningBooster(TaskSpec theTaskObject, ParameterHolder p, LearningModuleInterface LearningModule, ActionSelectorInterface theActionSelector) {
       return new ExpectedExperienceReplayLearningBooster(theTaskObject, p, LearningModule, theActionSelector);
    }

    @Override
    protected void addToPH(ParameterHolder p) {
        ExpectedExperienceReplayLearningBooster.addToParameterHolder(p);
    }
