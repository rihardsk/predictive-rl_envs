 ...
 * @author Brian Tanner
 */
public class ExperienceReplayLearningBoosterFactory extends AbstractLearningBoosterFactory {

    public ExperienceReplayLearningBoosterFactory(){
        
    }
    public ExperienceReplayLearningBoosterFactory(LearningModuleInterface theLearningModule, ActionSelectorInterface theActionSelector) {
    ...
    public LearningBoosterInterface makeLearningBooster(TaskSpec theTaskObject, ParameterHolder p, LearningModuleInterface LearningModule, ActionSelectorInterface theActionSelector) {
       return new ExperienceReplayLearningBooster(theTaskObject, p, LearningModule, theActionSelector);
    }

    @Override
    protected void addToPH(ParameterHolder p) {
       ExperienceReplayLearningBooster.addToParameterHolder(p);
    }
